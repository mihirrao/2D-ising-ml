...
def main():
    p = argparse.ArgumentParser(description='VAE 3D interactive visualization')
    ...
    ax1.set_xlabel('VAE Dim 1 (z=4)', fontsize=14, labelpad=10)
    ax1.set_ylabel('VAE Dim 2 (z=4)', fontsize=14, labelpad=10)
    ax1.set_zlabel('VAE Dim 3 (z=4)', fontsize=14, labelpad=15)
    ax1.zaxis.set_rotate_label(True)
    ax1.zaxis.labelpad = 15
    ax1.set_title('VAE Latent Dims 1-3 (Interactive)', fontsize=16, pad=15)
    ax1.legend(loc='upper left', fontsize=11, frameon=True, fancybox=False,
              edgecolor='black')
    ...
    ax2.set_xlabel(f'VAE PC1 ({explained_variance[0]:.2%} var)', fontsize=14, labelpad=10)
    ax2.set_ylabel(f'VAE PC2 ({explained_variance[1]:.2%} var)', fontsize=14, labelpad=10)
    ax2.set_zlabel(f'VAE PC3 ({explained_variance[2]:.2%} var)', fontsize=14, labelpad=15)
    ax2.zaxis.set_rotate_label(True)
    ax2.zaxis.labelpad = 15
    ax2.set_title('VAE PCA (Interactive)', fontsize=16, pad=15)
    ax2.legend(loc='upper left', fontsize=11, frameon=True, fancybox=False,
              edgecolor='black')
